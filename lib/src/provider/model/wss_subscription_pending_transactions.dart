...
@freezed
class WssSubscriptionPendingTransactionsResponse
    with _$WssSubscriptionPendingTransactionsResponse {
  ...
  factory WssSubscriptionPendingTransactionsResponse.fromJson(
          Map<String, Object?> json) =>
      _$WssSubscriptionPendingTransactionsResponseFromJson(json);
}

@freezed
class WssSubscriptionPendingTransactionsResult
    with _$WssSubscriptionPendingTransactionsResult {
  ...
  factory WssSubscriptionPendingTransactionsResult.fromJson(
          Map<String, Object?> json) =>
